...
function BreakfastFacility() {
  return (
    <div className="d-flex me-2 me-md-5 mt-1">
      <img className="facility-icon me-2" src={restaurantIcon} aria-label="breakfast available" />
...
function BreakfastFacilityNoText() {
  return <img className="facility-icon me-2" src={restaurantIcon} aria-label="breakfast available" />;
}
